...
#    to such a matrix (such as a numeric vector or a data frame
#    with all numeric columns)
#
# rep: maximum number of iterations (iter.max in kmeans())
...
#	    
#
# scaling.method: feature scaling method. In case the data has not been 
#			scaled, whether to use "standardization" or 
#			"z-score". By default, the function assumes 
